...
from scale_rl.networks.projection_utils import l2normalize, project_to_hypersphere
...
class HyperSimbaDevActor(nn.Module):
    num_blocks: int
    hidden_dim: int
    action_dim: int
    input_process_type: str
...
class HyperSimbaDevCritic(nn.Module):
    num_blocks: int
    hidden_dim: int
    input_process_type: str
    input_projection_type: str
...
class HyperSimbaDevClippedDoubleCritic(nn.Module):
    """
...
class HyperSimbaDevCategoricalCritic(nn.Module):
    num_blocks: int
    hidden_dim: int
    input_process_type: str
    input_projection_type: str
...
class HyperSimbaDevCategoricalDoubleCritic(nn.Module):
    """
...
class HyperSimbaDevTemperature(nn.Module):
